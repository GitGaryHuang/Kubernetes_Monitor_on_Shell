...
#layer_0
    ...
    while x_0 != ord('0'):
        ...
        screen_0.addstr(6, 4, "3 - Cluster Status")  
        screen_0.addstr(7, 4, "4 - Monitor Setting")
	...
	if x_0 == ord('2'):
        ...
        if x_0 == ord('3'):
            ...
            x_3 = 0
            while x_3 != ord('0'):
                screen_3 = curses.initscr()
                screen_3.clear()
                screen_3.border(0)
                screen_3.addstr(2, 2, "Pod Level or Node Level")
                screen_3.addstr(4, 4, "1 - Pod Level")
                screen_3.addstr(5, 4, "2 - Node Level")
                screen_3.addstr(6, 4, "3 - ...") 
                screen_3.addstr(9, 4, "0 - Exit")   
                screen_3.refresh()
                ...
                if x_3 == ord('1'):
                    curses.endwin()
                    execute_cmd("watch -n 60 -t kubectl get pods --all-namespaces -o wide")
                elif x_3 == ord('2'):
                    curses.endwin()
                    execute_cmd("watch -n 60 -t kubectl get nodes")
